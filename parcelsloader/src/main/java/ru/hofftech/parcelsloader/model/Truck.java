...
import ru.hofftech.parcelsloader.constants.DefaultValues;
...
public class Truck {
    ...
    @Getter
    private final List<PlacedParcelDto> placedParcels = new ArrayList<>();;
    ...
    public String getTruckType() { return String.format("%dx%d", width, height); }
    ...
    public void putParcel(MatrixPosition startPosition, Parcel parcel) {
        ...
        placedParcels.add(new PlacedParcelDto(
                parcel.getName(),
                parcel.getVolume(),
                startPosition.getRowNumber(),
                startPosition.getColumnNumber()));
